	...
	*/
	public function doExecute()
	{
		...
		*/
		...
		JLoader::register('InstallerModelDatabase', JPATH_ADMINISTRATOR . '/components/com_installer/models/database.php');
                $dbfix_install_model = new InstallerModelDatabase();
                $dbfix_install_model->fix();
